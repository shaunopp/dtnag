...
<body id="dairy" role="document">
    <cfinclude template="/ag/_/cfm/header.cfm"></cfinclude>

    <section class="container" role="main">
        <div class="row">
            <section class="col-md-8">
                <cfinclude template="/ag/_/cfm/dairy/article_dairy.cfm">
                <cfinclude  template="/ag/_/cfm/dairy/snippet_dairy_related.cfm">
            </section>
            <section class="col-md-4">
                <cfinclude template="/ag/_/cfm/snippet_trial_btn_well.cfm">
                <cfinclude template="/ag/_/cfm/dairy/aside_dairy.cfm">
            </section>
        </div>
    </section>
