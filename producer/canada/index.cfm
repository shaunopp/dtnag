...
<body id="canada" role="document">
    <cfinclude template="/ag/_/cfm/header.cfm"></cfinclude>

    <section class="container" role="main">
        <div class="row">
            <section class="col-md-8">
                <cfinclude template="/ag/_/cfm/canada/article_canada.cfm">
                <cfinclude  template="/ag/_/cfm/canada/snippet_canada_related.cfm">
            </section>
            <section class="col-md-4">
                <cfinclude template="/ag/_/cfm/snippet_trial_btn_well.cfm">
                <cfinclude template="/ag/_/cfm/canada/aside_canada.cfm">
            </section>
        </div>
    </section>
