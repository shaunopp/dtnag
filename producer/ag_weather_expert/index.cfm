...
<body id="ag_wx_expert" role="document">
    <cfinclude template="/ag/_/cfm/header.cfm"></cfinclude>

    <section class="container" role="main">
        <div class="row">
            <section class="col-md-8">
                <cfinclude template="/ag/_/cfm/ag_wx_expert/article_ag_wx_expert.cfm">
                <cfinclude  template="/ag/_/cfm/ag_wx_expert/snippet_ag_wx_expert_related.cfm">
            </section>
            <section class="col-md-4">
                <cfinclude template="/ag/_/cfm/snippet_trial_btn_well.cfm">
                <cfinclude template="/ag/_/cfm/ag_wx_expert/aside_ag_wx_expert.cfm">
            </section>
        </div>
    </section>
