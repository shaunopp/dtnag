...
<body id="sixfactors" role="document">
    <cfinclude template="/ag/_/cfm/header.cfm"></cfinclude>

    <section class="container" role="main">
        <div class="row">
            <section class="col-md-8">
                <cfinclude template="/ag/_/cfm/sixfactors/article_sixfactors.cfm">
                <cfinclude  template="/ag/_/cfm/sixfactors/snippet_sixfactors_related.cfm">
            </section>
            <section class="col-md-4">
                <cfinclude template="/ag/_/cfm/snippet_trial_btn_well.cfm">
                <cfinclude template="/ag/_/cfm/sixfactors/aside_sixfactors.cfm">
            </section>
        </div>
    </section>
