...
<body id="southern_crops" role="document">
    <cfinclude template="/ag/_/cfm/header.cfm"></cfinclude>

    <section class="container" role="main">
        <div class="row">
            <section class="col-md-8">
                <cfinclude template="/ag/_/cfm/southern_crops/article_sc.cfm">
                <cfinclude  template="/ag/_/cfm/southern_crops/snippet_sc_related.cfm">
            </section>
            <section class="col-md-4">
                <cfinclude template="/ag/_/cfm/snippet_trial_btn_well.cfm">
                <cfinclude template="/ag/_/cfm/southern_crops/aside_sc.cfm">
            </section>
        </div>
    </section>
