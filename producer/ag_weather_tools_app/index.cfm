...
<body id="agweathertoolsapp" role="document">
    <cfinclude template="/ag/_/cfm/header.cfm"></cfinclude>

    <section class="container" role="main">
        <div class="row">
            <section class="col-md-8">
                <cfinclude template="/ag/_/cfm/agweathertoolsapp/article_agweathertoolsapp.cfm">
                <cfinclude  template="/ag/_/cfm/agweathertoolsapp/snippet_agweathertoolsapp_related.cfm">
            </section>
