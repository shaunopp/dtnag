...
<body id="trading" role="document">
    ...
    <div class="container theme-showcase" role="main">
        ...
        <p>
            ...
            <button type="button" class="btn btn-lg btn-dtnblue">DTN Blue
            </button>
            <button type="button" class="btn btn-lg btn-dtnorange">DTN Orange
            </button>
            <button type="button" class="btn btn-lg btn-dtngreen">DTN Green
            </button>
        ...
        <div class="row">
            <div class="col-sm-4">
                <ul class="list-group css3-shadow">
