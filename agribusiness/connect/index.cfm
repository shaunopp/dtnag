...
<body id="connect" role="document">
    <cfinclude template="/ag/_/cfm/header.cfm"></cfinclude>

    <section class="container" role="main">
        <div class="row">
            <section class="col-md-8">
                <cfinclude template="/ag/_/cfm/connect/article_connect.cfm">
                <cfinclude  template="/ag/_/cfm/connect/snippet_connect_related.cfm">
            </section>
            <section class="col-md-4">
                <div class="well hidden-sm hidden-xs">
                    <a href="http://www.dtn.com/forms/ag/connect/new/<cfoutput>#connect_cookie_value#</cfoutput>" class="btn btn-dtnorange btn-lg btn-block top-trial" role="button" id="learnmore_button_aside"><i class="fa fa-chevron-right"></i> Learn more now </a>
                </div>
                <cfinclude template="/ag/_/cfm/connect/aside_connect.cfm">
            </section>
        </div>
    </section>
