...
<body id="portal" role="document">
    <cfinclude template="/ag/_/cfm/header.cfm"></cfinclude>

    <section class="container" role="main">
        <div class="row">
            <section class="col-md-8">
                <cfinclude template="/ag/_/cfm/portal/article_portal.cfm">
                <cfinclude  template="/ag/_/cfm/portal/snippet_portal_related.cfm">
            </section>
            <section class="col-md-4">
                <div class="well hidden-sm hidden-xs">
                    <a href="http://www.dtn.com/forms/ag/gtpdemo/new/<cfoutput>#portal_cookie_value#</cfoutput>" class="btn btn-dtnorange btn-lg btn-block top-trial" role="button" id="demo_button_aside"><i class="fa fa-chevron-right"></i> Request a demo </a>
                </div>
                <cfinclude template="/ag/_/cfm/portal/aside_portal.cfm">
            </section>
        </div>
    </section>
