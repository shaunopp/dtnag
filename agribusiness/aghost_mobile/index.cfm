...
<body id="aghost_mobile" role="document">
    <cfinclude template="/ag/_/cfm/header.cfm"></cfinclude>

    <section class="container" role="main">
        <div class="row">
            <section class="col-md-8">
                <cfinclude template="/ag/_/cfm/aghostmobile/article_aghostmobile.cfm">
                <cfinclude  template="/ag/_/cfm/aghostmobile/snippet_aghostmobile_related.cfm">
            </section>
