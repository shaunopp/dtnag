...
<body id="instant" role="document">
    <cfinclude template="/ag/_/cfm/header.cfm"></cfinclude>

    <section class="container" role="main">
        <div class="row">
            <section class="col-md-8">
                <cfinclude template="/ag/_/cfm/instant/article_instant.cfm">
                <cfinclude  template="/ag/_/cfm/instant/snippet_instant_related.cfm">
            </section>
            <section class="col-md-4">
                <div class="well hidden-sm hidden-xs">
                    <a href="http://www.dtn.com/forms/ag/try/dtnonline/new/<cfoutput>#instant_cookie_value#</cfoutput>" class="btn btn-dtnorange btn-lg btn-block top-trial" role="button" id="trial_button_aside"><i class="fa fa-chevron-right"></i> Start your free trial </a>
                </div>
                <cfinclude template="/ag/_/cfm/instant/aside_instant.cfm">
            </section>
        </div>
    </section>
