<article>
    <div class="row">
        <div class="col-md-8 col-sm-12 col-xs-12 description">
            <h1>DTN Livestock<sup>&reg;</sup>
            </h1>
            <h2>A complete livestock business and operations solution</h2>
        ...
        <div class="col-md-4 hidden-sm hidden-xs">
            <img class="img-circle spotlight img-responsive" src="/ag/images/producer_products/livestock_lg.jpg" alt="livestock photo" height="170px" width="170px">
        </div>
    </div>
    <br>
</article>