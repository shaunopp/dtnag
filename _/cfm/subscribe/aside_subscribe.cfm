<div class="well">
    <h3>Subscribe to our free <br>e-newsletters
    </h3>
    <p>To receive our e-newsletters please become a member of the DTN/The Progressive Farmer online community.</p>
    <ul class="fa-ul">
        <li><i class="fa-li fa fa-check-square-o"></i>
            Customize your weather
        </li>
        <li><i class="fa-li fa fa-check-square-o"></i>
            Participate in online discussions</li>
        <li><i class="fa-li fa fa-check-square-o"></i>
            Access special online sections</li>
        <li><i class="fa-li fa fa-check-square-o"></i>
            Read weekly e-mail newsletter</li>
    </ul>
    ...
    <p>For a limited time, receive a free introductory issue of our industry-leading print magazine &mdash; that's 13 issues in all!
    ...
    <ul class="fa-ul">
        ...
        <li><i class="fa-li fa fa-check-square-o"></i>
            The latest news and how-to articles from the most-awarded editorial team in the agriculture industry</li>
        <li><i class="fa-li fa fa-check-square-o"></i>
            Free trial issue with no obligation</li>
        <li><i class="fa-li fa fa-check-square-o"></i>
            13 issues for only $16!</li>
