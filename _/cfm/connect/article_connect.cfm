<article>
    <div class="row">
        <div class="col-md-8 col-sm-12 col-xs-12 description">
            <h1>DTN Connect<sup>&trade;</sup>
            </h1>
            <h2>Become a trusted advisor to your customers</h2>
            <p>DTN Connect allows sales people to be relevant year round by connecting silos of information, provide advisory discussions, generate sales in the field, create proposals and document engagement.  </p>
            <ul class="fa-ul">
            ...
            <a href="http://www.dtn.com/forms/ag/connect/new/<cfoutput>#connect_cookie_value#</cfoutput>" class="btn btn-dtnorange btn-lg" role="button"><i class="fa fa-chevron-right"></i> Learn more now </a>
        </div>
