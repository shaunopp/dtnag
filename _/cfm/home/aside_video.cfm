<aside class="video">
    <div class="list-group css3-shadow">
        <a href="#" class="list-group-item active" id="aside_header_video"><i class="fa fa-vimeo-square"></i> <strong>Video:</strong> Producer Solution</a>
        <a href="#" class="list-group-item vidpreview-lg" data-toggle="modal" data-target="#1" onClick="ga('send', 'event', 'Video', 'Played', 'Homepage_MyDTN_0914', {'nonInteraction': 1})" id="agwx_station_video">
            <i class="fa fa-youtube-play fa-5x"></i>
            <img src="http://i.vimeocdn.com/video/487334914_640.jpg" class="img-rounded img-responsive">
        </a>
