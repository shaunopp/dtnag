<section class="list-group css3-shadow">
    ...
    <a href="/ag/_/pdf/ag_wx_station/fl_ag_weather_station_2013.pdf" class="list-group-item" target="_blank"><i class="fa fa-file-pdf-o pad-rt"></i>DTN Ag Weather Station</a>
