        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <p class="copy text-center">
                    ...
                    &copy;2002-2014 DTN. All Rights Reserved. DTN is a registered trademark and the property of DTN. All other trademarks are the properties of their respective owners.
                </p>
            </div>
        </div>
    </div>
